  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 px-4 pt-4 pb-3 header-blur border-b border-[#30363D]/30">
      <div className="max-w-2xl mx-auto flex items-center justify-between">
        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#C1322B] to-[#8B1F1A] flex items-center justify-center shadow-lg">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1.5 bg-[#1C2128]/80 backdrop-blur-sm rounded-full px-3 py-1.5 shadow-lg border border-[#30363D]">
